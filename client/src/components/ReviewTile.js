  ...
  return (
    <div className="review_tile">
        <div className="review_details">
          ...
          <h5 className="classNameReview"><span className="header_text">Student Name: </span>{props.studentId}</h5>
          <h5 className="classNameReview"><span className="header_text">Session Time: </span>{props.description}</h5>
